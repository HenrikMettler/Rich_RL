...
n_epsisodes: int = 50  # 5000
n_steps: int = 10  # 10000
...
for episode in range(n_epsisodes):
    ...
    for steps in range(n_steps):
        ...
        if env_cont_flag:
            ...
            action = get_stoch_action_from_output(output_activity=output_activity)
